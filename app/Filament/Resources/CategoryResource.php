...
use Filament\Forms\Components\TextInput; // Import komponen TextInput
use Filament\Tables\Columns\TextColumn; // Import komponen TextColumn
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                TextInput::make('name')
                    ->required()
                    ->unique(ignoreRecord: true) // Pastikan nama kategori unik (tidak boleh ada dua kategori dengan nama yang sama)
                    ->maxLength(255)
                    ->label('Nama Kategori'),
            ]);
    }
