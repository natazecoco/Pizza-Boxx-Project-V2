...
<div class="container mx-auto py-16 px-4">
    <div class="bg-white rounded-2xl shadow-xl p-10 text-center max-w-xl mx-auto animate-fade-in-up">
        ...
        <a href="{{ route('pegawai.dashboard') }}" class="inline-block mt-4 bg-brand-red hover:bg-red-700 text-white font-bold px-6 py-3 rounded-xl shadow transition-all">Kembali ke Dashboard</a>
    </div>
</div>
@endsection