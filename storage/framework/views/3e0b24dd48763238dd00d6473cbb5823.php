<?php $__env->startSection('content'); ?>
    ...
    <section class="bg-brand-red pt-32 pb-12 lg:pt-44 lg:pb-16 relative overflow-hidden rounded-b-[2.5rem] lg:rounded-b-[4rem] shadow-[0px_12px_0px_0px_rgba(0,0,0,0.1)] z-10 border-b-4 border-gray-900">
        ...
        <img src="<?php echo e(asset('images/pizzabanner.png')); ?>" class="absolute -right-24 top-20 w-[400px] opacity-20 rotate-12 blur-sm pointer-events-none hidden lg:block">
            ...
            <?php if(empty($cart)): ?>
                ...
                <div class="flex flex-col items-center justify-center py-12">
                    <div class="bg-white rounded-[3rem] p-12 lg:p-16 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.05)] border-4 border-dashed border-gray-200 text-center max-w-xl mx-auto w-full group hover:border-gray-900 transition-colors duration-300">
                        ...
                        <a href="<?php echo e(route('menu.index')); ?>" class="inline-flex bg-gray-900 text-white font-black py-4 px-10 rounded-2xl text-xs uppercase tracking-[0.2em] transition-all hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(220,38,38,1)] border-2 border-transparent">
            ...
            <?php else: ?>
                <div class="flex flex-col lg:flex-row gap-8 items-start relative">
                    ...
                    <div class="w-full lg:w-[65%] space-y-4 lg:space-y-6">
                        <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemKey => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-[2.5rem] p-4 lg:p-6 shadow-sm border-2 border-transparent hover:border-gray-900 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden">
                            ...
                            <div class="flex gap-4 lg:gap-6 relative z-10">
                                <div class="w-24 h-24 lg:w-36 lg:h-36 flex-shrink-0">
                                    <img src="<?php echo e(asset('storage/' . $item['image_path'])); ?>" class="w-full h-full object-cover rounded-2xl shadow-md border-2 border-gray-100 group-hover:border-gray-900 transition-colors">
                                </div>
                                <div class="flex-grow flex flex-col justify-between py-1">
                                    <div class="mb-3">
                                        <div class="flex justify-between items-start">
                                            <div>
                                                <h3 class="text-lg lg:text-2xl font-black text-gray-900 uppercase italic leading-none mb-2 group-hover:text-brand-red transition-colors"><?php echo e($item['name']); ?></h3>
                                                <div class="flex flex-wrap gap-1.5 mb-2">
                                                    <?php if($item['size_option']): ?> <span class="px-2 py-0.5 rounded-lg bg-gray-100 border border-gray-200 text-[9px] font-black text-gray-500 uppercase tracking-wider"><?php echo e($item['size_option']['name']); ?></span> <?php endif; ?>
                                                    <?php if($item['crust_option']): ?> <span class="px-2 py-0.5 rounded-lg bg-gray-100 border border-gray-200 text-[9px] font-black text-gray-500 uppercase tracking-wider"><?php echo e($item['crust_option']['name']); ?></span> <?php endif; ?>
                                                </div>
                                            </div>
                                        ...
                                        <?php if(!empty($item['addons'])): ?>
                                            <div class="mt-1">
                                                ...
                                                <p class="text-[10px] text-gray-600 font-bold leading-tight line-clamp-2">+ <?php echo e(collect($item['addons'])->pluck('name')->implode(', ')); ?></p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="flex flex-col-reverse sm:flex-row sm:items-end justify-between gap-3 mt-auto">
                                        <div class="flex items-center bg-gray-50 p-1.5 rounded-xl border border-gray-200 w-max group-hover:border-gray-900 transition-colors">
                                            <form action="<?php echo e(route('cart.update')); ?>" method="POST">
                                                <?php echo csrf_field(); ?> <input type="hidden" name="item_key" value="<?php echo e($itemKey); ?>"> <input type="hidden" name="quantity" value="<?php echo e($item['quantity'] - 1); ?>">
                                            ...
                                            <span class="text-sm lg:text-base font-black text-gray-900 italic w-8 text-center"><?php echo e($item['quantity']); ?></span>
                                            <form action="<?php echo e(route('cart.update')); ?>" method="POST">
                                                <?php echo csrf_field(); ?> <input type="hidden" name="item_key" value="<?php echo e($itemKey); ?>"> <input type="hidden" name="quantity" value="<?php echo e($item['quantity'] + 1); ?>">
                                        ...
                                        <div class="text-right">
                                            <p class="text-lg lg:text-2xl font-black text-brand-red italic tracking-tighter">Rp <?php echo e(number_format($item['total_price'], 0, ',', '.')); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="sticky bottom-4 z-40 mx-2 mb-2 bg-white/95 backdrop-blur-md rounded-[2rem] border-2 border-gray-900 p-5 lg:hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                            <div class="flex items-center justify-between gap-3">
                                <div class="flex flex-col pl-2">
                                    ...
                                    <span class="text-2xl font-black text-brand-red italic tracking-tighter leading-none">Rp <?php echo e(number_format($cartTotal, 0, ',', '.')); ?></span>
                                </div>
                        ...
                        <div class="bg-gray-900 rounded-[2.5rem] p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.3)] relative overflow-hidden border-4 border-gray-900">
                            ...
                            <div class="relative z-10">
                                <div class="flex justify-between items-center mb-8 pb-6 border-b border-gray-800">
                                    ...
                                    <span class="bg-brand-red text-white text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-lg border-2 border-gray-900 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"><?php echo e(count($cart)); ?> Items</span>
                                </div>
                                <div class="flex justify-between items-end mb-2">
                                    <span class="text-gray-400 text-xs font-bold uppercase tracking-widest">Subtotal</span>
                                    <span class="text-3xl font-black text-white italic tracking-tighter">Rp <?php echo e(number_format($cartTotal, 0, ',', '.')); ?></span>
                                </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/pages/cart/index.blade.php ENDPATH**/ ?>