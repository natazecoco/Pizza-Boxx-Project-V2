    ...
    <div class="group">
        ...
        <div class="relative">
            ...
            <input type="email" name="email" required value="<?php echo e(old('email')); ?>"
                   class="w-full pl-12 pr-4 py-4 bg-white border-2 <?php echo e($errors->has('email') ? 'border-brand-red' : 'border-gray-200'); ?> rounded-xl focus:border-gray-900 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] outline-none font-bold text-gray-900 transition-all placeholder-gray-300 text-sm"
    ...
    <div class="group">
        <div class="flex justify-between items-center mb-2 ml-1">
            ...
            <!-- <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" class="text-[9px] font-black uppercase tracking-widest text-gray-400 hover:text-brand-red transition-colors">Lupa?</a>
            <?php endif; ?> -->
        ...
        <div class="relative">
            ...
            <input type="password" name="password" required
                   class="w-full pl-12 pr-4 py-4 bg-white border-2 <?php echo e($errors->has('password') ? 'border-brand-red' : 'border-gray-200'); ?> rounded-xl focus:border-gray-900 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] outline-none font-bold text-gray-900 transition-all placeholder-gray-300 text-sm"
                   placeholder="••••••••">
        </div>
...
</form><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/partials/customer/_login-form.blade.php ENDPATH**/ ?>