...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <p class="text-gray-500 mt-1">Berikut adalah ringkasan performa toko hari ini, <?php echo e(date('d F Y')); ?>.</p>
    </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-800 mt-1">Rp<?php echo e(number_format($todaySales)); ?></h3>
                </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-800 mt-1"><?php echo e($todayOrdersCount); ?></h3>
                </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-800 mt-1"><?php echo e($pendingOrdersCount); ?></h3>
                </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-purple-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-black text-gray-800 mt-1"><?php echo e($onDeliveryCount); ?></h3>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('pegawai.orders.index')); ?>" class="text-xs font-bold text-brand-red hover:underline">Lihat Semua →</a>
            </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="text-sm">
                        ...
                        <tr class="border-t border-gray-50">
                            <td class="py-4 font-bold">#<?php echo e($order->id); ?></td>
                            <td class="py-4"><?php echo e($order->customer_name); ?></td>
                            <td class="py-4"><span class="px-2 py-1 bg-gray-100 rounded text-[10px] font-bold uppercase"><?php echo e($order->order_type); ?></span></td>
                            <td class="py-4">
                                <span class="px-2 py-1 rounded-full text-[10px] font-bold 
                                    <?php if($order->status == 'pending'): ?> bg-yellow-100 text-yellow-700
                                    <?php elseif($order->status == 'completed' || $order->status == 'delivered'): ?> bg-green-100 text-green-700
        ...
        <div class="bg-brand-red rounded-3xl p-8 text-white shadow-xl shadow-red-200">
            ...
            <div class="space-y-4">
                <a href="<?php echo e(route('pegawai.orders.index')); ?>" class="flex items-center justify-between bg-white/20 p-4 rounded-2xl hover:bg-white/30 transition-all border border-white/20">
                    <span class="font-bold">Daftar Pesanan</span>
                    <i class="fas fa-chevron-right"></i>
                </a>
                <a href="<?php echo e(route('pegawai.deliveries.index')); ?>" class="flex items-center justify-between bg-white/20 p-4 rounded-2xl hover:bg-white/30 transition-all border border-white/20">
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/pages/employee/dashboard.blade.php ENDPATH**/ ?>