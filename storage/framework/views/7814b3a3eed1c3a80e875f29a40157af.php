...
<section class="bg-brand-red pt-44 pb-24 relative overflow-hidden">
    ...
    <img src="<?php echo e(asset('images/pizzabanner.png')); ?>" class="absolute -right-24 top-32 w-[500px] opacity-20 rotate-12 blur-sm pointer-events-none hidden lg:block">
                        ...
                        <?php $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($social['link']): ?> 
                                ...
                                class="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center text-white border border-gray-700 hover:bg-brand-red hover:border-brand-red hover:-translate-y-1 transition-all duration-300 group shadow-md">
                                    <i class="<?php echo e($social['icon']); ?> text-sm group-hover:animate-bounce"></i>
                                </a>
                            <?php endif; ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="text-[9px] text-brand-red font-black uppercase mt-1 ml-1 tracking-widest"><i class="fas fa-exclamation-circle"></i> <?php echo e($message); ?></p>
                            <?php unset($message);
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const outlets = <?php echo json_encode($outlets ?? [], 15, 512) ?>; 
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/pages/Front/contact.blade.php ENDPATH**/ ?>