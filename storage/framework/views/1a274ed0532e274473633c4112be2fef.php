    ...
    <div class="container mx-auto px-6 lg:px-12 relative z-10 text-center">
        ...
        <div class="inline-flex flex-wrap justify-center gap-4">
            <div class="bg-gray-900 text-white px-6 py-3 rounded-2xl border-2 border-transparent shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)]">
                ...
                <p class="text-xl font-black leading-none"><?php echo e($orders->count()); ?></p>
            </div>
            <div class="bg-white text-gray-900 px-6 py-3 rounded-2xl border-2 border-transparent shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)]">
                ...
                <p class="text-xl font-black text-brand-red leading-none"><?php echo e($orders->whereIn('status', ['pending', 'dapur', 'on_delivery'])->count()); ?></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="space-y-6">
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                <div class="flex items-center gap-2 mb-1">
                                    <h3 class="text-xl font-black text-gray-900 italic uppercase tracking-tighter leading-none">#<?php echo e($order->order_code ?? $order->id); ?></h3>
                                    
                                    <span class="<?php echo e($conf['bg']); ?> <?php echo e($conf['text']); ?> border <?php echo e($conf['border']); ?> px-2.5 py-0.5 rounded-md text-[9px] font-black uppercase tracking-widest flex items-center gap-1.5">
                                        <i class="fas <?php echo e($conf['icon']); ?>"></i> <?php echo e($order->status); ?>

                                    </span>
                                </div>
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                    <?php echo e($order->created_at->format('d M Y')); ?> • <?php echo e($order->created_at->format('H:i')); ?> WIB
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-row md:flex-col items-center md:items-end justify-between gap-2 md:gap-4 border-t md:border-t-0 pt-4 md:pt-0 border-dashed border-gray-100">
                            <div class="text-left md:text-right">
                                ...
                                <p class="text-xl font-black text-brand-red italic leading-none">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></p>
                            </div>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="bg-white rounded-[3rem] py-24 text-center border-2 border-dashed border-gray-200">
                    ...
                    <a href="<?php echo e(route('menu.index')); ?>" class="inline-flex bg-brand-red text-white font-black py-4 px-10 rounded-2xl text-xs uppercase tracking-widest hover:bg-gray-900 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] border-2 border-transparent">
                        Pesan Sekarang
                    </a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/pages/customer/dashboard.blade.php ENDPATH**/ ?>