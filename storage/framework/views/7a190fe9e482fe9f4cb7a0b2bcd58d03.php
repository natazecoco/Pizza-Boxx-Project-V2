                    ...
                    <div class="w-full lg:w-[35%] lg:sticky lg:top-32">
                        <div class="bg-gray-900 rounded-[3rem] p-8 border-4 border-gray-900 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.15)] relative overflow-hidden">
                            ...
                            <div class="relative z-10">
                                ...
                                <input type="hidden" name="customer_name" value="<?php echo e($user->name); ?>">
                                <input type="hidden" name="customer_email" value="<?php echo e($user->email); ?>">
                                <input type="hidden" name="customer_phone" value="<?php echo e($primaryAddress->phone ?? $user->phone_number); ?>">
        ...
        <div class="bg-white w-full max-w-xl rounded-[3rem] brutalist-card flex flex-col max-h-[85vh] overflow-hidden">
            ...
            <div class="p-6 overflow-y-auto custom-scrollbar space-y-4 bg-slate-50 flex-grow">
                <?php $__empty_1 = true; $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div onclick="selectAddress(<?php echo e(json_encode($addr)); ?>)" class="group cursor-pointer p-6 rounded-[2rem] border-4 border-transparent bg-white shadow-sm hover:border-gray-900 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all relative">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-[10px] text-gray-400 font-black mt-2 uppercase tracking-widest italic"><?php echo e($addr->city); ?> • <?php echo e($addr->phone); ?></p>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="receiver_name" value="<?php echo e(Auth::user()->name); ?>" required class="w-full bg-white border-2 border-gray-200 p-4 rounded-xl focus:border-gray-900 outline-none font-bold text-sm brutalist-input mt-1">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" value="<?php echo e(Auth::user()->phone_number); ?>" required class="w-full bg-white border-2 border-gray-200 p-4 rounded-xl focus:border-gray-900 outline-none font-bold text-sm brutalist-input mt-1">
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            window.saveNewAddress = function() {
                ...
                fetch("<?php echo e(route('user.address.store')); ?>", { 
                    method: 'POST',
