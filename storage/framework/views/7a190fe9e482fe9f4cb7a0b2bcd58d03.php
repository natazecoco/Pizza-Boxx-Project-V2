...
<body class="min-h-screen bg-slate-50 selection:bg-brand-red selection:text-white pb-32 lg:pb-12">
    ...
    <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b-4 border-gray-900 shadow-sm">
        <div class="container mx-auto px-4 lg:px-8 max-w-6xl h-20 flex items-center justify-between">
            <a href="<?php echo e(route('cart.index')); ?>" class="group flex items-center gap-3">
            ...
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/pizza-boxx-logo.png')); ?>" class="h-8 w-8 object-contain">
                            ...
                            <div class="mb-8" id="branch-selector-container">
                                ...
                                <select name="location_id" id="location_id" class="hidden">
                                    ...
                                    <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($location->id); ?>" data-address="<?php echo e($location->address); ?>" data-map-url="<?php echo e($location->maps_url); ?>">
                                ...
                                <div id="branch-options" class="hidden absolute left-0 right-0 mx-6 lg:mx-8 bg-white border-4 border-gray-900 rounded-[2rem] shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] mt-2 z-50 overflow-hidden max-h-72 overflow-y-auto custom-scrollbar">
                                    <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div onclick="selectBranchCustom('<?php echo e($location->id); ?>', '<?php echo e($location->name); ?>', '<?php echo e($location->address); ?>')" 
                                            ...
                                            <div>
                                                <h5 class="text-sm font-black text-gray-900 uppercase italic"><?php echo e($location->name); ?></h5>
                                                <p class="text-[10px] text-gray-500 font-bold mt-0.5"><?php echo e($location->address); ?></p>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            ...
                            <div id="address_section" class="space-y-4">
                                ...
                                <div class="border-4 border-gray-900 rounded-[2rem] p-6 relative bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                                    <div class="flex justify-between items-start gap-4">
                                        <div>
                                            <span id="display_label" class="bg-gray-900 text-white text-[10px] font-black uppercase px-3 py-1.5 rounded-lg tracking-widest"><?php echo e($primaryAddress ? $primaryAddress->label : '?'); ?></span>
                                            <p id="display_address" class="text-base font-bold text-gray-800 mt-4 leading-relaxed">
                                                <?php echo e($primaryAddress ? $primaryAddress->address : 'Klik tombol ganti untuk pilih alamat.'); ?>

                                            </p>
                                            <p id="display_phone" class="text-sm font-black text-brand-red mt-2 italic tracking-tight"><?php echo e($primaryAddress ? $primaryAddress->phone : ''); ?></p>
                                        </div>
                                    ...
                                    <input type="hidden" name="delivery_address" id="inp_address" value="<?php echo e($primaryAddress ? $primaryAddress->address : ''); ?>">
                                    <input type="hidden" name="latitude" id="inp_lat" value="<?php echo e($primaryAddress ? $primaryAddress->latitude : ''); ?>">
                                    <input type="hidden" name="longitude" id="inp_lng" value="<?php echo e($primaryAddress ? $primaryAddress->longitude : ''); ?>">
                                </div>
                        ...
                        <div class="bg-gray-900 rounded-[3rem] p-8 border-4 border-gray-900 shadow-[12px_12px_0px_0px_rgba(0,0,0,0.15)] relative overflow-hidden">
                            ...
                            <div class="relative z-10">
                                <h3 class="text-white font-black uppercase italic tracking-tighter text-2xl mb-8 border-b-2 border-gray-800 pb-6 flex justify-between items-center">
                                    RINGKASAN
                                    <span class="text-[10px] bg-brand-red px-3 py-1 rounded-full not-italic tracking-widest"><?php echo e(count($cart)); ?> Items</span>
                                </h3>
                                    ...
                                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex justify-between items-start gap-4 group">
                                            <div class="flex gap-4">
                                                ...
                                                <div>
                                                    <h4 class="text-sm font-black text-white uppercase italic leading-none group-hover:text-brand-red transition-colors"><?php echo e($item['name']); ?></h4>
                                                    <p class="text-[9px] text-gray-500 font-black mt-1 uppercase tracking-widest">
                                                        <?php if(isset($item['size_option']['name'])): ?> <?php echo e($item['size_option']['name']); ?> <?php endif; ?>
                                                        <?php if(isset($item['crust_option']['name'])): ?> • <?php echo e($item['crust_option']['name']); ?> <?php endif; ?>
                                                    </p>
                                                </div>
                                            </div>
                                            <p class="text-sm font-black text-gray-300 italic shrink-0">
                                                <?php echo e(number_format($item['total_price'] / 1000, 0)); ?>k
                                            </p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                ...
                                <div class="space-y-3 mb-10 bg-black/30 p-6 rounded-[2rem] border-2 border-gray-800">
                                    <div class="flex justify-between text-xs font-black text-gray-500 uppercase tracking-widest">
                                        <span>Subtotal</span>
                                        <span class="text-gray-200 italic">Rp <?php echo e(number_format($cartTotal, 0, ',', '.')); ?></span>
                                    </div>
                                    ...
                                    <div class="flex justify-between items-center pt-4 border-t-2 border-gray-800 mt-4">
                                        ...
                                        <span class="font-black text-brand-red text-2xl italic tracking-tighter drop-shadow-sm" id="txt_total">Rp <?php echo e(number_format($cartTotal, 0, ',', '.')); ?></span>
                                    </div>
                                </div>

                                <input type="hidden" name="subtotal_amount" value="<?php echo e($cartTotal); ?>">
                                <input type="hidden" name="delivery_fee" id="inp_fee" value="0">
                                <input type="hidden" name="discount_amount" id="inp_discount" value="0">
                                <input type="hidden" name="total_amount" id="inp_total" value="<?php echo e($cartTotal); ?>">
                                <input type="hidden" name="customer_name" id="inp_name" value="<?php echo e($user->name); ?>">
                                <input type="hidden" name="customer_email" value="<?php echo e($user->email); ?>">
                                <input type="hidden" name="customer_phone" id="inp_phone" value="<?php echo e($primaryAddress->phone ?? $user->phone_number); ?>">
            ...
            <div id="address-list-container" class="p-6 overflow-y-auto custom-scrollbar space-y-4 bg-slate-50 flex-grow">
                <?php $__empty_1 = true; $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="group relative p-6 rounded-[2rem] border-4 border-transparent bg-white shadow-sm hover:border-gray-900 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all flex justify-between items-start gap-4">
                        ...
                        <div onclick="selectAddress(<?php echo e(json_encode($addr)); ?>)" class="flex-grow cursor-pointer">
                            <span class="bg-gray-900 text-white text-[9px] font-black uppercase px-3 py-1.5 rounded-lg tracking-widest"><?php echo e($addr->label); ?></span>
                            <p class="text-base font-bold text-gray-900 mt-4 leading-tight"><?php echo e($addr->address); ?></p>
                            <p class="text-[10px] text-gray-400 font-black mt-2 uppercase tracking-widest italic">
                                <?php echo e($addr->city ?? ''); ?> • <?php echo e($addr->phone); ?>
                        ...
                        <div class="flex flex-col gap-2 shrink-0">
                            ...
                            <button onclick="editAddressInModal(event, <?php echo e(json_encode($addr)); ?>)" class="w-10 h-10 rounded-xl bg-gray-100 border-2 border-transparent text-gray-400 hover:bg-white hover:text-brand-red hover:border-brand-red hover:shadow-md transition-all flex items-center justify-center z-20">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="group">
                            ...
                            <input type="text" name="receiver_name" value="<?php echo e(Auth::user()->name); ?>" required 
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="group">
                                ...
                                <input type="tel" name="phone" value="<?php echo e(Auth::user()->phone_number); ?>" required 
                                    class="w-full bg-white border-2 border-gray-200 p-4 rounded-xl focus:border-gray-900 focus:ring-0 outline-none font-bold text-sm brutalist-input transition-all placeholder-gray-300">
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="province" id="modal-province"> 
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const subtotal = parseFloat("<?php echo e($cartTotal); ?>") || 0;
            let currentFee = 0;
            ...
            window.openCreateAddress = function() {
                ...
                // Set Action Store
                el.formNewAddr.action = "<?php echo e(route('user.address.store')); ?>";
            ...
            window.editAddressInModal = function(e, data) {
                ...
                // Set Action Update
                let updateUrl = "<?php echo e(route('user.address.update', ':id')); ?>";
                ...
                // Isi Form
                el.formNewAddr.querySelector('[name="receiver_name"]').value = data.receiver_name || "<?php echo e(Auth::user()->name); ?>";
            ...
            function resetModalForm() {
                ...
                el.formNewAddr.querySelector('[name="receiver_name"]').value = "<?php echo e(Auth::user()->name); ?>";
                el.formNewAddr.querySelector('[name="phone"]').value = "<?php echo e(Auth::user()->phone_number); ?>";
            }
            ...
            window.saveNewAddress = function() {
                ...
                .then(data => {
                    ...
                    if(data.success) {
                        ...
                        if(el.inpName) el.inpName.value = resultAddr.receiver_name || "<?php echo e(Auth::user()->name); ?>";
            ...
            window.selectAddress = function(addr) {
                ...
                if(el.inpName) el.inpName.value = addr.receiver_name || "<?php echo e(Auth::user()->name); ?>";
...
</html><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/pages/checkout/index.blade.php ENDPATH**/ ?>