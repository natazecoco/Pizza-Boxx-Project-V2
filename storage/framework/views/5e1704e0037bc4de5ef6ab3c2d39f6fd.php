...
<div class="container mx-auto py-8 px-4 max-w-4xl">
    <div class="flex justify-between items-center mb-6 no-print">
        <a href="<?php echo e(route('pegawai.orders.index')); ?>" class="text-gray-600 hover:text-brand-red font-bold flex items-center gap-2 transition-colors">
        ...
        <div class="flex gap-3">
            ...
            <a href="https://wa.me/<?php echo e($formattedPhone); ?>?text=<?php echo e($waMessage); ?>" 
            target="_blank" 
    ...
    <div id="printable-area" class="bg-white shadow-xl overflow-hidden border border-gray-100">
        <div class="bg-brand-red p-8 text-white flex justify-between items-center">
            ...
            <div class="text-right">
                <p class="text-lg font-bold">#<?php echo e($order->id); ?></p>
                <p class="text-xs opacity-80"><?php echo e($order->created_at->format('d F Y, H:i')); ?> WIB</p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-gray-600"><i class="fas fa-phone-alt mr-2 text-red-500"></i> <?php echo e($order->customer_phone); ?></p>
                        <p class="text-gray-600">
                            <i class="fas fa-map-marker-alt mr-2 text-red-500"></i> 
                            <?php echo e($order->order_type === 'pickup' ? 'Ambil di Toko (Self-Pickup)' : ($order->delivery_address ?? '-')); ?>
                ...
                <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="text-sm font-bold uppercase text-brand-red"><?php echo e($order->order_type); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-sm text-gray-500">Status Saat Ini:</span>
                        <span class="text-sm font-bold uppercase text-blue-600"><?php echo e(str_replace('_', ' ', $order->status)); ?></span>
                    </div>
                </div>
            </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors group">
                            ...
                            <td class="py-5">
                                <p class="font-black text-gray-800 text-lg uppercase leading-none"><?php echo e($item->product_name); ?></p>
                                <?php if($item->options): ?>
                                    <div class="mt-2 flex flex-wrap gap-1">
                                        ...
                                        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="text-[10px] bg-yellow-100 text-orange-800 px-2 py-0.5 rounded-md font-black border border-orange-200 uppercase">
                                                ...
                                                <?php echo e(is_array($opt) ? ($opt['name'] ?? '-') : trim($opt)); ?>
                            ...
                            <td class="py-5 text-center font-black text-xl text-gray-800"><?php echo e($item->quantity); ?></td>
                            <td class="py-5 text-right font-bold text-gray-800">Rp<?php echo e(number_format($item->unit_price * $item->quantity)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot>
                        <tr class="border-t-2 border-gray-200">
                            ...
                            <td class="py-6 text-right text-2xl font-black text-brand-red">Rp<?php echo e(number_format($order->total_amount)); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 mt-8 border-l-4 border-blue-500 no-print">
        ...
        <div class="mb-4 no-print">
            <?php if(isset($nextAction['url'])): ?>
                <a href="<?php echo e($nextAction['url']); ?>" class="w-full <?php echo e($nextAction['color']); ?> text-white py-6 rounded-2xl font-black text-2xl shadow-xl hover:scale-[1.01] transition-all flex items-center justify-center gap-4">
                    <i class="fas <?php echo e($nextAction['icon']); ?> animate-bounce"></i>
            ...
            <?php else: ?>
                <form action="<?php echo e(route('pegawai.orders.update-status', $order->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="status" value="<?php echo e($nextAction['status']); ?>">
                    <button type="submit" class="w-full <?php echo e($nextAction['color']); ?> text-white py-6 rounded-2xl font-black text-2xl shadow-xl hover:scale-[1.01] transition-all flex items-center justify-center gap-4">
                        <i class="fas <?php echo e($nextAction['icon']); ?> animate-bounce"></i>
                        <?php echo e($nextAction['label']); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                <div class="md:col-span-2">
                    ...
                    <select name="status" id="status" class="w-full rounded-xl border-gray-300 p-3 bg-gray-50">
                        ...
                        <option value="accepted" <?php echo e($order->status == 'accepted' ? 'selected' : ''); ?>>Diterima (Accepted)</option>
                        <option value="preparing" <?php echo e($order->status == 'preparing' ? 'selected' : ''); ?>>Sedang Dimasak (Preparing)</option>
                        
                        <?php if($order->order_type === 'delivery'): ?>
                            <option value="ready_for_delivery" <?php echo e($order->status == 'ready_for_delivery' ? 'selected' : ''); ?>>Siap Diantar</option>
                            <option value="on_delivery" <?php echo e($order->status == 'on_delivery' ? 'selected' : ''); ?>>Sedang Diantar</option>
                            <option value="delivered" <?php echo e($order->status == 'delivered' ? 'selected' : ''); ?>>Sudah Sampai (Delivered)</option>
                        <?php else: ?>
                            <option value="ready_for_pickup" <?php echo e($order->status == 'ready_for_pickup' ? 'selected' : ''); ?>>Siap Diambil</option>
                        <?php endif; ?>

                        <option value="cancelled" <?php echo e($order->status == 'cancelled' ? 'selected' : ''); ?>>Batalkan Pesanan</option>
                    </select>
                </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 mt-8 border border-gray-100 no-print">
        ...
        <div class="relative">
            ...
            <div class="relative pl-10 mb-8">
                ...
                <p class="text-xs text-gray-400"><?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB</p>
            </div>
            ...
            <div class="relative pl-10 mb-8">
                ...
                <p class="text-xs text-gray-400">Terakhir diperbarui: <?php echo e($order->updated_at->format('d M Y, H:i')); ?> WIB</p>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/pages/employee/show.blade.php ENDPATH**/ ?>