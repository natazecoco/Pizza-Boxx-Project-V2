<?php $__env->startSection('content'); ?>
    ...
    <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show" 
        ...
        <div class="bg-gray-900 text-white px-6 py-4 rounded-2xl shadow-[8px_8px_0px_0px_rgba(220,38,38,1)] flex items-center gap-4 border-2 border-white">
            ...
            <p class="text-xs font-black uppercase tracking-widest"><?php echo e(session('success')); ?></p>
        </div>
    </div>
    <?php endif; ?> -->
    ...
    <section class="bg-brand-red pt-44 pb-24 relative overflow-hidden">
        ...
        <img src="<?php echo e(asset('images/pizzabanner.png')); ?>" class="absolute -right-24 top-20 w-[600px] opacity-20 rotate-12 blur-sm pointer-events-none hidden lg:block">
        ...
        <div class="container mx-auto px-4 lg:px-12">
            ...
            <div class="sticky top-4 z-40 transition-all duration-500 ease-in-out">
                ...
                <div id="category-navbar-pill" class="bg-white/90 backdrop-blur-lg py-3 px-2 mb-12 max-w-max mx-auto border-2 border-gray-900 rounded-full shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] relative z-40">
                    <div class="flex gap-2 overflow-x-auto no-scrollbar lg:justify-center px-2" id="category-nav">
                        <?php $__currentLoopData = $categoriesWithProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="space-y-20 pb-24">
                <?php $__currentLoopData = $categoriesWithProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div id="category-<?php echo e($category->id); ?>" class="scroll-mt-[110px] lg:scroll-mt-[20px] category-section">    
                        ...
                        <div class="section-border flex items-end gap-4 mb-10 border-b-4 border-gray-900 pb-4 transition-colors duration-300">
                            ...
                            <span class="item-count text-xs font-bold text-gray-400 uppercase tracking-widest mb-1 ml-auto transition-colors duration-300">
                                <?php echo e($category->products->count()); ?> Items
                            </span>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
                            <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div id="product-<?php echo e($product->id); ?>" class="group relative bg-slate-50 rounded-[2rem] p-4 border-2 border-transparent hover:border-gray-900 hover:bg-white hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
                                    ...
                                    <div class="relative h-48 lg:h-56 mb-5 overflow-hidden rounded-[1.5rem] bg-white border-2 border-gray-100 group-hover:border-gray-900 transition-colors">
                                        <?php if($product->image_path): ?>
                                            <img src="<?php echo e(asset('storage/' . $product->image_path)); ?>" 
                                                 loading="lazy" alt="<?php echo e($product->name); ?>"
                                    ...
                                    <div class="flex flex-col flex-grow px-2">
                                        ...
                                        <p class="text-gray-500 text-[11px] font-bold leading-relaxed mb-4 line-clamp-2 h-8">
                                            <?php echo e($product->description ?? 'Nikmati sensasi rasa otentik.'); ?>
                                        ...
                                        <div class="mt-auto flex items-end justify-between border-t-2 border-dashed border-gray-200 pt-4 group-hover:border-gray-900 transition-colors">
                                            ...
                                            <a href="<?php echo e(route('menu.show', $product->id)); ?>" 
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const branchLocationData = <?php echo json_encode($branchLocationData, 15, 512) ?>;
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/pages/Front/menu.blade.php ENDPATH**/ ?>