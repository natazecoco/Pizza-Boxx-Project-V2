            ...
            <div class="md:w-5/12 bg-brand-red bg-pizza-pattern-white p-8 md:p-12 flex flex-col justify-center items-center text-center relative overflow-hidden border-b-2 md:border-b-0 md:border-r-2 border-gray-900">
                ...
                <div class="relative z-10 text-white">
                    ...
                    <p class="text-sm md:text-base font-medium opacity-90 max-w-xs mx-auto">
                        Terima kasih, <span class="font-black underline decoration-wavy decoration-white/50"><?php echo e(explode(' ', $order->customer_name)[0]); ?></span>!<br>
            ...
            <div class="md:w-7/12 p-8 md:p-12 bg-white flex flex-col justify-center">
                ...
                <div class="grid grid-cols-2 gap-4 mb-8">
                    <div>
                        ...
                        <p class="text-sm font-black text-gray-900 uppercase">#<?php echo e($order->order_code ?? $order->id); ?></p>
                    </div>
                    <div>
                        <p class="text-[9px] font-bold text-gray-400 uppercase tracking-wider mb-1">Total Bayar</p>
                        <p class="text-sm font-black text-brand-red">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></p>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="group block w-full bg-brand-dark hover:bg-brand-red text-white text-center font-black py-4 rounded-xl uppercase tracking-widest text-xs transition-all shadow-[4px_4px_0px_0px_rgba(220,38,38,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] border-2 border-transparent">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a href="https://wa.me/6281218928030?text=Halo%20PizzaBoxx%2C%20saya%20mau%20konfirmasi%20order%20%23<?php echo e($order->id); ?>" target="_blank" class="flex items-center justify-center gap-2 bg-white hover:bg-green-50 text-gray-900 font-bold py-3 rounded-xl uppercase text-[10px] transition-all border-2 border-gray-200 hover:border-green-500 hover:text-green-600">
                            <i class="fab fa-whatsapp text-lg"></i> Konfirmasi
                        </a>
                        <a href="<?php echo e(route('home')); ?>" class="flex items-center justify-center gap-2 bg-white hover:bg-gray-50 text-gray-900 font-bold py-3 rounded-xl uppercase text-[10px] transition-all border-2 border-gray-200 hover:border-brand-red hover:text-brand-red">
...
</html><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/pages/checkout/success.blade.php ENDPATH**/ ?>