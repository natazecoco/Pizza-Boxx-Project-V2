...
<?php if(session('success')): ?>
    <div x-data="{ show: true }"
        ...
        <div class="flex flex-col">
            ...
            <p class="text-sm font-black uppercase italic tracking-tighter"><?php echo e(session('success')); ?></p>
        </div>
...
<?php if(session('error')): ?>
    <div x-data="{ show: true }"
        ...
        <div class="flex flex-col">
            ...
            <p class="text-sm font-black uppercase italic tracking-tighter"><?php echo e(session('error')); ?></p>
        </div>
    </div>
<?php endif; ?> -->
...
</style><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/partials/shared/overlays.blade.php ENDPATH**/ ?>