    ...
    <div :class="{ 
        ...
        <div class="flex-1 flex items-center">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 group">
                <img src="<?php echo e(asset('images/pizza-boxx-logo.png')); ?>" alt="Logo"
        ...
        <div class="flex-1 flex items-center justify-end gap-3 sm:gap-4">
            ...
            <a href="<?php echo e(route('cart.index')); ?>" class="relative p-3 rounded-2xl bg-gray-50 text-gray-900 hover:bg-gray-900 hover:text-white transition-all group border-2 border-transparent hover:border-gray-400">
            ...
            <div class="hidden lg:block">
                <?php if(Auth::check() && !Auth::user()->hasAnyRole(['admin', 'employee'])): ?>
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        ...
                        <div x-show="open" x-transition 
                            ...
                            <div class="px-6 py-3 border-b border-gray-100 mb-2">
                                ...
                                <p class="text-sm font-black text-gray-900 truncate uppercase italic tracking-tighter"><?php echo e(Auth::user()->name); ?></p>
                            </div>
                            <div class="px-2 space-y-1">
                                <a href="<?php echo e(route('user.profile')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-2xl hover:bg-red-50 text-gray-600 hover:text-brand-red transition-all font-black text-[10px] uppercase tracking-widest">
                                    <i class="fas fa-user-circle text-lg w-6 text-center"></i> Profil Saya
                                </a>
                                <a href="<?php echo e(route('user.dashboard')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-2xl hover:bg-red-50 text-gray-600 hover:text-brand-red transition-all font-black text-[10px] uppercase tracking-widest">
                                    <i class="fas fa-box-open text-lg w-6 text-center"></i> Pesanan
                                </a>
                                <form action="<?php echo e(route('logout')); ?>" method="POST" class="pt-2 border-t border-gray-50 mt-2">
                                    <?php echo csrf_field(); ?>
            ...
            <?php if(Auth::check()): ?>
                ...
                <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-3xl border-2 border-gray-100">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-black text-gray-900 uppercase italic leading-tight truncate max-w-[150px]"><?php echo e(Auth::user()->name); ?></p>
                    </div>
                </div>
...
</div><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/partials/customer/header.blade.php ENDPATH**/ ?>