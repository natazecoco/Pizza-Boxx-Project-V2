<form method="POST" action="<?php echo e(route('register')); ?>" 
    ...
    <div class="group">
        ...
        <input type="text" name="name" required value="<?php echo e(old('name')); ?>"
               class="w-full px-5 py-4 bg-white border-2 <?php echo e($errors->has('name') ? 'border-brand-red' : 'border-gray-200'); ?> rounded-xl focus:border-gray-900 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] outline-none font-bold text-gray-900 transition-all shadow-sm placeholder-gray-300 text-sm"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="group">
        ...
        <input type="email" name="email" required value="<?php echo e(old('email')); ?>"
               class="w-full px-5 py-4 bg-white border-2 <?php echo e($errors->has('email') ? 'border-brand-red' : 'border-gray-200'); ?> rounded-xl focus:border-gray-900 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] outline-none font-bold text-gray-900 transition-all shadow-sm placeholder-gray-300 text-sm"
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="group">
            ...
            <input type="password" name="password" required
                   class="w-full px-5 py-4 bg-white border-2 <?php echo e($errors->has('password') ? 'border-brand-red' : 'border-gray-200'); ?> rounded-xl focus:border-gray-900 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] outline-none font-bold text-gray-900 transition-all shadow-sm placeholder-gray-300 text-sm"
                   placeholder="••••••••">
        </div>
        <div class="group">
...
</form><?php /**PATH C:\xampp\htdocs\pizza-boxx-web-v2\resources\views/partials/customer/_register-form.blade.php ENDPATH**/ ?>